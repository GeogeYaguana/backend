...
CREATE TABLE place_opening_time (
    id SERIAL PRIMARY KEY,
    monday VARCHAR(50),
    tuesday VARCHAR(50),
...
-- Crear la tabla tour_operator
CREATE TABLE public.tour_operator (
    id SERIAL PRIMARY KEY,
    name VARCHAR(100) NOT NULL,
...
-- Insertar datos en la tabla tour_operator
...
INSERT INTO public.tour_operator(
    id, name, description, email, phone, facebook, instagram, twitter, "webSite", thumbnail)
VALUES
    (3, 'BMTours', 'Bmtours es tu agencia de viajes online en Ecuador. Encuentra los mejores paquetes turísticos, vuelos, hoteles, cruceros y alquiler de autos al mejor precio.', 'web@bmtours.com.ec', '+593 93 980 2588', 'https://www.facebook.com/bmtoursec', 'https://www.instagram.com/bmtoursec/', 'https://twitter.com/bmtours?lang=es','https://bmtours.com.ec', 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1c/41/78/70/bm-tours-es-tiempo-de.jpg?w=1200&h=-1&s=1');

INSERT INTO public.tour_operator(
    id, name, description, email, phone, facebook, instagram, twitter, "webSite", thumbnail)
VALUES
    (4, 'Destino Libre', 'Operadora de Turismo Especializado en Ecuador, viaja a donde desees.', 'operaciones@destinolibre.com.ec', '+593 99 817 5473', 'https://www.facebook.com/destinolibreec/?locale=es_LA', 'https://www.instagram.com/destinolibre/', '-----','http://www.destinolibre.com.ec', 'https://scontent.fgye30-1.fna.fbcdn.net/v/t39.30808-6/294931600_441937614612143_3343786944956267060_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=efb6e6&_nc_ohc=yN0QV160ImoAX9LUiYT&_nc_ht=scontent.fgye30-1.fna&oh=00_AfD18lctgFKPwzUi49j8OfrKKXbNq5NxUuLlOvQ5XAOuFQ&oe=65A41DD5');
...
CREATE TABLE place (
    ...
    "cantonId" INTEGER,
    "categoryId" INTEGER,
    "openingTimesId" INTEGER,
    thumbnail VARCHAR(200),
    points INTEGER DEFAULT 0,
    CONSTRAINT fk_category FOREIGN KEY("categoryId") REFERENCES category(id),
    CONSTRAINT fk_canton FOREIGN KEY("cantonId") REFERENCES canton(id),
    CONSTRAINT fk_place_opening_time FOREIGN KEY("openingTimesId") REFERENCES place_opening_time(id)
);
...
VALUES 
    ...
    -- Crear la tabla place_photo
CREATE TABLE public.place_photo (
    id SERIAL PRIMARY KEY,
    "imageName" VARCHAR(200) NOT NULL,
    "placeId" INTEGER NOT NULL,
    CONSTRAINT fk_place FOREIGN KEY("placeId") REFERENCES place(id)
);
...
-- Crear la tabla tour_operator_photo
CREATE TABLE public.tour_operator_photo (
    id SERIAL PRIMARY KEY,
    "imageName" VARCHAR(200) NOT NULL,
    "tourOperatorId" INTEGER NOT NULL,
    CONSTRAINT fk_tour_operator FOREIGN KEY("tourOperatorId") REFERENCES tour_operator(id)
);

-- Insertar datos para el primer conjunto de imágenes (tourOperatorId: 1)
...
-- Insertar datos para el segundo conjunto de imágenes (tourOperatorId: 2)
INSERT INTO public.tour_operator_photo(id, "imageName", "tourOperatorId") VALUES
...
-- Insertar datos para el tercer conjunto de imágenes (tourOperatorId: 3)
INSERT INTO public.tour_operator_photo(id, "imageName", "tourOperatorId") VALUES
...
-- Insertar datos para el cuarto conjunto de imágenes (tourOperatorId: 4)
INSERT INTO public.tour_operator_photo(id, "imageName", "tourOperatorId") VALUES
...
-- Insertar datos para el ejemplo 1
INSERT INTO public.store(id, name, description, phone, address, "gpsCoordinates", "cantonId")
VALUES (1, 'Restaurante Guayaquil Delicioso', 'Comida local y internacional', '123-456-7890', 'Avenida Principal 123, Guayaquil', POINT(-2.2038, -79.8975), 1);

-- Insertar datos para el ejemplo 2
INSERT INTO public.store(id, name, description, phone, address, "gpsCoordinates", "cantonId")
VALUES (2, 'Cevichería Sabor a Mar', 'Especialidad en ceviches frescos', '987-654-3210', 'Calle del Mar 456, Salinas', POINT(-2.2228, -80.9597), 2);

-- Insertar datos para el ejemplo 3
INSERT INTO public.store(id, name, description, phone, address, "gpsCoordinates", "cantonId")
VALUES (3, 'Parrillada El Ranchero', 'Carnes a la parrilla y asados', '555-123-4567', 'Avenida Carnes 789, Durán', POINT(-2.1685, -79.8734), 3);
...
-- Insertar datos para el evento 'Fiesta de la Virgen del Carmen'
INSERT INTO public.event (
    ...
    'Una celebración religiosa y cultural que se realiza cada 16 de julio en honor a la Virgen del Carmen, patrona de los pescadores y marineros. Se realizan procesiones, misas, bailes y juegos pirotécnicos.',
    '04-256-7890', 'Barrio Las Peñas, Guayaquil', POINT(-2.189412, -79.883558), 1,
    'https://www.facebook.com/fiestavirgendelcarmen/', 'https://www.instagram.com/fiestavirgendelcarmen/',
    'https://twitter.com/fiestavirgendelcarmen/', 'https://www.tiktok.com/@fiestavirgendelcarmen',
    'https://www.goraymi.com/es-ec/guayas/guayaquil/fiestas/fiesta-de-la-virgen-del-carmen-avgpvvedq',
    'https://i0.wp.com/tengoseddeti.org/wp-content/uploads/2019/07/salutacionesvirgendelcarmen_blog.jpg?fit=795%2C551&ssl=1'
);

-- Insertar datos para el evento 'Carnaval Guayaquil 2024'
INSERT INTO public.event (
    id, name, description, phone, address, "gpsCoordinates", "cantonId", facebook, instagram, twitter, tiktok, "webSite", thumbnail
) VALUES (
    2, 'Carnaval Guayaquil 2024',
    'Un evento que se celebra cada año en el mes de febrero, con desfiles, conciertos, ferias, exposiciones y mucha diversión. El carnaval de Guayaquil es uno de los más grandes y coloridos del país.',
    '04-234-5678', 'Malecón 2000, Guayaquil', POINT(-2.196160, -79.886207), 1,
    'https://www.facebook.com/carnavalguayaquil/', 'https://www.instagram.com/carnavalguayaquil/',
    'https://twitter.com/carnavalguayaquil/', 'https://www.tiktok.com/@carnavalguayaquil',
    'https://www.guayaquilesmidestino.com/es/eventos/carnaval-guayaquil-2017',
    'https://3.bp.blogspot.com/-CAfdO7eh8HM/VMlUA52_U8I/AAAAAAAAPTU/tdhu3XVOpgM/s1600/Programa%2Bde%2Bfiestas%2BCarnaval%2BGuayaquil%2B2015.jpg'
);

-- Insertar datos para el evento 'Festival de la Fruta en Pedro Carbo'
INSERT INTO public.event (
    id, name, description, phone, address, "gpsCoordinates", "cantonId", facebook, instagram, twitter, tiktok, "webSite", thumbnail
) VALUES (
    3, 'Festival de la Fruta',
    'Un evento que se realiza cada año en el mes de agosto, para promover la producción y el consumo de frutas tropicales como el mango, la papaya, el maracuyá y el coco. Se realizan concursos, exposiciones, degustaciones y venta de productos derivados de las frutas.',
    '04-276-5432', 'Parque Central, Pedro Carbo', POINT(-1.833333, -80.233333), 3,
    'https://www.facebook.com/festivaldelafruta/', 'https://www.instagram.com/festivaldelafruta/',
    'https://twitter.com/festivaldelafruta/', 'https://www.tiktok.com/@festivaldelafruta',
    'https://www.goraymi.com/es-ec/guayas/pedro-carbo/fiestas/festival-de-la-fruta-avgpvvedq',
    'https://static.wixstatic.com/media/935275_f83f66bceb29484b9ff76a88bfe33f43~mv2.jpg/v1/fill/w_770,h_500,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/FIESTA%20PATRONAL%202.jpg'
);

-- Insertar datos para el evento 'Festival de Arte Urbano'
INSERT INTO public.event (
    id, name, description, phone, address, "gpsCoordinates", "cantonId", facebook, instagram, twitter, tiktok, "webSite", thumbnail
) VALUES (
    4, 'Festival de Arte Urbano',
    'Disfruta de un evento que celebra la creatividad urbana con murales, grafitis, música en vivo y actividades interactivas para todas las edades.',
    '04-222-4567', 'Malecón Simón Bolívar, Guayaquil', POINT(-2.1968594841329234, -79.88029862667229), 10,
    'https://www.facebook.com/festivalarteurbano/', 'https://www.instagram.com/festivalarteurbano/',
    'https://twitter.com/arteurbano_ec', 'https://www.tiktok.com/@arteurbano',
    'https://www.festivaldearteurbano.ec/',
    'https://www.eluniverso.com/resizer/vkweI-5jsYm0o2zB6_FPbPnCNhc=/1005x670/smart/filters:quality(70)/cloudfront-us-east-1.images.arcpublishing.com/eluniverso/MKTZLZQXQ5FJPP4S4MXLMM4KQY.jpg'
);

-- Insertar datos para el evento 'Feria Gastronómica Sabores de Guayaquil'
INSERT INTO public.event (
    id, name, description, phone, address, "gpsCoordinates", "cantonId", facebook, instagram, twitter, tiktok, "webSite", thumbnail
) VALUES (
    5, 'Feria Gastronómica Sabores de Guayaquil',
    'Descubre la riqueza culinaria de Guayaquil con una feria que reúne a los mejores chefs y restaurantes de la ciudad. Prueba platos tradicionales y experimenta nuevos sabores.',
    '04-333-6789', 'Parque Centenario, Guayaquil', POINT(-2.205014, -79.897697), 10,
    'https://www.facebook.com/feriagastronomica/', 'https://www.instagram.com/saboresdeguayaquil/',
    'https://twitter.com/sabores_gye', 'https://www.tiktok.com/@saboresdeguayaquil',
    'https://www.saboresdeguayaquil.com/',
    'https://www.inmobiliar.gob.ec/wp-content/uploads/2021/09/57fd19eb-01a8-40aa-bf34-a51b99c47014.jpeg'
);

-- Insertar datos para el evento 'Concierto en el Parque Seminario'
INSERT INTO public.event (
    id, name, description, phone, address, "gpsCoordinates", "cantonId", facebook, instagram, twitter, tiktok, "webSite", thumbnail
) VALUES (
    6, 'Concierto en el Parque Seminario',
    'Vive una noche llena de música con un concierto al aire libre en el Parque Seminario. Artistas locales te harán vibrar con diferentes géneros musicales.',
    '04-234-5678', 'Parque Seminario, Guayaquil', POINT(-2.194665500284182, -79.8836765401625), 10,
    'https://www.facebook.com/conciertoparqueseminario/', 'https://www.instagram.com/conciertoparqueseminario/',
    'https://twitter.com/conciertogye', 'https://www.tiktok.com/@conciertoparqueseminario',
    'https://www.conciertoparqueseminario.ec/',
    'https://www.eluniverso.com/resizer/l-uFFmuxYFPxRNuZQOtb9DNkt1Q=/1013x670/smart/filters:quality(70)/cloudfront-us-east-1.images.arcpublishing.com/eluniverso/RGAF2ZH7UBFWVFZHWYPRD6A6YQ.png'
);

-- Insertar datos para el evento 'Exposición de Arte Contemporáneo'
INSERT INTO public.event (
    id, name, description, phone, address, "gpsCoordinates", "cantonId", facebook, instagram, twitter, tiktok, "webSite", thumbnail
) VALUES (
    7, 'Exposición de Arte Contemporáneo',
    'Explora la creatividad de artistas contemporáneos en una exposición única. Pinturas, esculturas y nuevas formas de expresión te esperan en este evento cultural.',
    '04-345-6789', 'Centro de Convenciones de Guayaquil', POINT(-2.203272, -79.897349), 10,
    'https://www.facebook.com/expoartecontemporaneo/', 'https://www.instagram.com/artecontemporaneogye/',
    'https://twitter.com/artecont_gye', 'https://www.tiktok.com/@artecontemporaneo',
    'https://www.expoartecontemporaneo.com/',
    'https://arteaunclick.es/wp-content/uploads/2018/05/Ana-Laura-Aláez_Mujeres-sobre-zapatos-de-plataforma-28199229.jpg'
);

-- Insertar datos para el evento 'Festival de Cine Independiente'
INSERT INTO public.event (
    id, name, description, phone, address, "gpsCoordinates", "cantonId", facebook, instagram, twitter, tiktok, "webSite", thumbnail
) VALUES (
    8, 'Festival de Cine Independiente',
    'Sumérgete en el mundo del cine independiente con proyecciones de películas únicas y la oportunidad de interactuar con directores y actores. Una experiencia cinematográfica diferente.',
    '04-456-7890', 'Cinepolis, Mall del Sol, Guayaquil', POINT(-2.168504, -79.915477), 10,
    'https://www.facebook.com/festivalcineindependiente/', 'https://www.instagram.com/cineindependientegye/',
    'https://twitter.com/festcinegye', 'https://www.tiktok.com/@cineindependientegye',
    'https://www.festivalcineindependiente.ec/',
    'https://i0.wp.com/www.eluniverso.com/resizer/nmPKkjosaxfYPwXdmTSYO_1AUtc=/1190x670/smart/filters:quality(70)/cloudfront-us-east-1.images.arcpublishing.com/eluniverso/XCNMN2QUWNFCXPOOKOEXDKMJMU.jpeg?w=696&ssl=1'
);

-- Insertar datos para el evento 'Exhibición de Autos Clásicos'
INSERT INTO public.event (
    id, name, description, phone, address, "gpsCoordinates", "cantonId", facebook, instagram, twitter, tiktok, "webSite", thumbnail
) VALUES (
    9, 'Exhibición de Autos Clásicos',
    'Admira la elegancia y el diseño atemporal de autos clásicos en esta exhibición anual. Una oportunidad única para los amantes de los automóviles y la historia del motor.',
    '04-567-8901', 'Parque Histórico, Samborondón', POINT(-2.1442589564902024, -79.86916573941042), 22,
    'https://www.facebook.com/exhibicionautosclasicos/', 'https://www.instagram.com/autosclasicosgye/',
    'https://twitter.com/clasicosgye', 'https://www.tiktok.com/@autosclasicosgye',
    'https://www.exhibicionautosclasicos.com/',
    'https://www.lahora.com.ec/wp-content/uploads/2023/02/autos-clasicos.jpg'
);
CREATE TABLE IF NOT EXISTS public.cupon (
    ...
    thumbnail TEXT,
    FOREIGN KEY ("storeId") REFERENCES public.store(id)
);
...
-- Crear la tabla event_opening_date
CREATE TABLE IF NOT EXISTS public.event_opening_date (
    id SERIAL PRIMARY KEY,
...
-- Insertar datos de ejemplo en la tabla event_opening_date
...
CREATE TABLE public.event_photo (
    ...
    "eventId" INTEGER REFERENCES public.event(id) ON DELETE CASCADE
);
...
CREATE TABLE public.user_cupon (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    quantity INTEGER NOT NULL,
    "userId" UUID NOT NULL REFERENCES public.user(id) ON DELETE CASCADE,
    "cuponId" INTEGER NOT NULL REFERENCES public.cupon(id) ON DELETE CASCADE,
    code TEXT NOT NULL
);
-- Usuario 1, Cupón 1
...
CREATE TABLE public.event_review (
    ...
    "eventId" INTEGER NOT NULL REFERENCES public.event(id) ON DELETE CASCADE,
    "userId" UUID NOT NULL REFERENCES public.user(id) ON DELETE CASCADE,
...
CREATE TABLE public.favorite_place (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    "placeId" INTEGER NOT NULL REFERENCES public.place(id) ON DELETE CASCADE,
    "userId" UUID NOT NULL REFERENCES public.user(id) ON DELETE CASCADE
);
